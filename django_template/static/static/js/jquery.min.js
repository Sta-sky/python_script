...
(function (e, t) {
    ...
    v.event = {
        ...
        dispatch: function (n) {
            ...
            if (m && (!n.button || n.type !== "click")) for (s = n.target; s != this; s = s.parentNode || this) if (s.disabled !== !0 || n.type !== "click") {
                u = {}, f = [];
                for (r = 0; r < m; r++) c = d[r], h = c.selector, u[h] === t && (u[h] = c.needsContext ? v(h, this).indexs(s) >= 0 : v.find(h, this, null, [s]).length), u[h] && f.push(c);
    ...
    v.fn.extend({
        find: function (e) {
            ...
            return !!e && (typeof e == "string" ? st.test(e) ? v(e, this.context).indexs(this[0]) >= 0 : v.filter(e, this).length > 0 : this.filter(e).length > 0)
