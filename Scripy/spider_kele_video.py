...
class Spider_Video():
    def __init__(self):
        self.url = 'https://www.kele15.com/video/video_list.html?video_type={}&page_index={}'
        ...
        self.new_save_path = 'F:\\MAT\\video\\kele\\{}.mp4'
...
class MyKeleSpider(Thread, Spider_Video):
    def __init__(self, user_th_name):
        super().__init__()
    ...
    def run(self):
        self.pruduct_queue()
        video_totle = self.url_quueu.qsize()
